        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#" className="text-slate-400 hover:text-white flex items-center">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-slate-400 hover:text-white">For Entrepreneurs</a></li>
              <li><a href="#" className="text-slate-400 hover:text-white">For Job Seekers</a></li>
              <li><a href="#" className="text-slate-400 hover:text-white">Idea Validation</a></li>
